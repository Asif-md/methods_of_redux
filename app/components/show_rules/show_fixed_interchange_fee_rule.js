...
class ShowFixedInterchangeFeeRule extends React.Component{
    ...
    return (
      <div className="collapse in" id="collapseExample3">
        ...
        <div className="form-group">
          ...
          <div className="details">{rule.fee}</div>
        </div>
        <div className="form-group">
          <Boolean
            flag={rule.taxable}
...
ShowFixedInterchangeFeeRule.propTypes = {
  rule: PropTypes.object.isRequired
}
export default connect(mapStateToProps, mapDispatchToProps)(ShowFixedInterchangeFeeRule);
