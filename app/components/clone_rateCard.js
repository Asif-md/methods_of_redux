...
class CloneRateTemplateModal extends React.Component {
            ...
            <div id="myModal" className="modal">
                <div className="modal-content">
                    {this.state.onRulesetClickEnabled
                        ...
                        :
                        <div>
                            <span className="close1" onClick={this.props.onOpenMainModal}>&times;</span>
...
export default CloneRateTemplateModal;
